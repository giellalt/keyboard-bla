.. -*- mode: rst -*-
==========================================
 Keyboards for the Siksika language
==========================================

This directory contains source files and build instructions for developing
keyboards for the Siksika language. The data and implementations
...
* http://giellatekno.uit.no/bladoc/index.html
* http://divvun.no/doc/tools/docu-bla-manual.html
...
The Siksika keyboard sources can be acquired using the `Giella SVN
